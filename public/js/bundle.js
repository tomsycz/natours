...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoidG9tc3ljeiIsImEiOiJja2txNGViMnYxajlvMm9uc3I0NXBxZzYyIn0.pENmROhbsP1pa0OWKPNaHQ';
  var map = new mapboxgl.Map({
    container: 'map',
    style: 'mapbox://styles/tomsycz/ckkqxv0862okg17pey2gy6y1m',
    scrollZoom: false // center: [-118.2229744352004, 34.06766963568984],
    // pitch: 60,
    // bearing: -60,
    // zoom: 10,
    // interactive: false,
...
var stripe = Stripe('pk_test_51IIyzELvS3CXtm12hNYfDijrfYDSJPWdXnnlvnx99zTGsNEXISXN2d5dIZ9lskRlBMwbIDAtNzRufPoq0bzAgz3E005N8pRWEN');
